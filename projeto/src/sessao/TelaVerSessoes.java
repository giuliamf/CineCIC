...
public class TelaVerSessoes extends JFrame {
    ...
    public TelaVerSessoes(int idFilme) {
        ...
        JButton btnFiltrar = criarBotao("Filtrar", "resources/icones/filter.png", 90, 30, idFilme);
        ...
        // Botões
        JButton btnProx = criarBotao("Próximo", "resources/icones/continuar.png", 105, 30, idFilme);
        JButton btnVoltar = criarBotao("Voltar", "resources/icones/voltar.png", 90, 30, idFilme);
