...
public class TelaAreaCliente extends JFrame {
    ...
    public TelaAreaCliente() {
        ...
        JButton botaoVerDados = criarBotao("Ver dados da conta", "resources/icones/view.png",200, 50);   // espaços extras para centralizar as imagens
        panelGerenciar.add(botaoVerDados);

        JButton botaoAttCadastro = criarBotao("Atualizar cadastro", "resources/icones/update.png",200, 50);   // espaços extras para centralizar as imagens
        panelGerenciar.add(botaoAttCadastro);

        // Botão de mudar a senha
        JButton botaoMudarSenha = criarBotao("Mudar a senha", "resources/icones/edit.png",200, 50);
        panelGerenciar.add(botaoMudarSenha);

        // Botão de excluir conta
        JButton botaoExcluirConta = criarBotao("Excluir a conta", "resources/icones/lixeira.png",200, 50);
        ...
        JButton botaoAddPedido = criarBotao("Fazer pedido", "resources/icones/pedido.png",200, 50);   // espaços extras para centralizar as imagens
        panelPedido.add(botaoAddPedido);

        // Botão de carrinho
        JButton botaoCarrinho = criarBotao("Abrir carrinho", "resources/icones/cart.png",200, 50);   // espaços extras para centralizar as imagens
        ...
        // Botão de histórico
        JButton botaoHistorico = criarBotao("Consultar histórico", "resources/icones/history.png",200, 50);   // espaços extras para centralizar as imagens
        panelConsulta.add(botaoHistorico);

        // Botão de promocao
        JButton botaoPromocoes = criarBotao("Consultar promoções", "resources/icones/promotions.png",200, 50);   // espaços extras para centralizar as imagens
