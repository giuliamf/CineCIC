...
public class GerenciaCliente {
    ...
    public void salvarCadastro(Cliente cliente) {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("resources/banco de dados/dadosClientes.csv", true))){
    ...
    public String atualizarCadastro(Cliente clienteLogado) {
        ...
        if (clienteEncontrado) {
            try (BufferedWriter bw = new BufferedWriter(new FileWriter("resources/banco de dados/dadosClientes.csv"))) {
                for (Cliente c : clientes) {
    ...
    private List<Cliente> lerClientes() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("resources/banco de dados/dadosClientes.csv"))) {
            String linha;
