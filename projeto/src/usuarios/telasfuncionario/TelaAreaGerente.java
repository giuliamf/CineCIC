...
public class TelaAreaGerente extends JFrame {
    public TelaAreaGerente() {
        ...
        JButton botaoAddFuncionario = criarBotao("Cadastrar novo funcionário", "resources/icones/adicionar.png",230, 50);   // espaços extras para centralizar as imagens
        panelGerenciar.add(botaoAddFuncionario);

        // Botão de remover filme
        JButton botaoRmvFuncionario = criarBotao("Remover funcionário", "resources/icones/remover.png", 230, 50);
        panelGerenciar.add(botaoRmvFuncionario);

        // Botão de editar filme
        JButton botaoEditFuncionario = criarBotao("Editar funcionário", "resources/icones/edit.png", 230, 50);
        ...
        JButton botaoSair = criarBotao("Voltar", "resources/icones/voltar.png", 100, 50);
