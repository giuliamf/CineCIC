...
public class TelaLoginFuncionario extends JFrame {
    ...
    private void handleLogin() {
        String email = userField.getText(); // Pega o email digitado
        String pass = new String(passField.getPassword());  // Pega a senha digitada

        // Verifica se o login foi bem sucedido
        Login login = new Login("Funcionario"); // Cria um objeto de login de funcionário
        GerenciaFuncionario gerenciaFuncionario = new GerenciaFuncionario();    // Cria um objeto de gerência de funcionários
        Funcionario funcionario = gerenciaFuncionario.buscarFuncionarioEmail(email);    // Busca o funcionário pelo email
