...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        topBtnPanel.add(criarBotao("Área do Cliente", "resources/icones/cliente.png", 30, 30, 200));  // Cria o botão
        topBtnPanel.add(Box.createRigidArea(new Dimension(30, 0)));   // Espaçamento entre os botões

            // Botão "Área do Funcionário"
        topBtnPanel.add(criarBotao("Área do Funcionário", "resources/icones/funcionario.png", 30, 30, 200));  // Cria o botão
        ...
        centralBtnPanel.add(criarBotao("Acessar o catálogo", "resources/icones/catalogue.png", 50, 50, 300)); // Cria o botão
        centralBtnPanel.add(Box.createRigidArea(new Dimension(30, 0)));   // Espaçamento entre os botões

            // Botão "Consultar promoções"
        centralBtnPanel.add(criarBotao("Consultar promoções", "resources/icones/discount.png", 50, 50, 300)); // Cria o botão
