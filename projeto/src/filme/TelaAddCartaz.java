...
public class TelaAddCartaz extends JFrame {
    GerenciaFilme gerenciaFilme = new GerenciaFilme();
    JComboBox box;

    public TelaAddCartaz() {
        ...
        panelEscolha.setBorder(BorderFactory.createTitledBorder("Escolha o filme para adicionar ao cartaz"));
        ...
        // Botão de refresh
        JButton botaoRefresh = criarBotao("Atualizar lista", "resources/icones/reload.png", 140, 30, 5);
        gbc.gridy = 1;
        ...
        JButton botaoAdicionar = criarBotao("Adicionar", "resources/icones/adicionar.png", 140, 30, 5);
        JButton botaoSair = criarBotao("Voltar", "resources/icones/voltar.png", 140, 30, 5);
    ...
    public JButton criarBotao(String nomeBotao, String caminhoIcon, int width, int height, int gap) {
        ...
        botao.addActionListener(_ -> {
            ...
            switch (nomeBotao) {
                case "Adicionar" -> {
                    if (gerenciaFilme.verificaEspacoCartaz()) {
                        assert idFilme != null;
                        gerenciaFilme.colocarEmCartaz(idFilme);
                        JOptionPane.showMessageDialog(null, "Filme adicionado ao cartaz com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
                    } else {
