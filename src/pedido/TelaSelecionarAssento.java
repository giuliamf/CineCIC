...
public class TelaSelecionarAssento extends JFrame {
    ...
    public TelaSelecionarAssento(Map<Integer, Boolean> mapaAssentos, ArrayList<Integer> listIdFilmeSessao) {
        ...
        JButton btnConfirmar = criarBotao("Próximo", "Interface/Icons/continuar.png", 120, 30, listIdFilmeSessao);
        JButton btnVoltar = criarBotao("Voltar", "Interface/Icons/voltar.png", 105, 30, listIdFilmeSessao);
        JButton btnCancelar = criarBotao("Cancelar", "Interface/Icons/cancelar.png", 120, 30, listIdFilmeSessao);
