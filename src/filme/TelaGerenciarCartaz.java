...
public class TelaGerenciarCartaz extends JFrame {
    public TelaGerenciarCartaz() {
        ...
        // Botões
        JButton botaoAdd = criarBotao("Adicionar filme ao cartaz", "Interface/Icons/adicionar.png", 210, 30);
        JButton botaoRemove = criarBotao("Remover filme do cartaz", "Interface/Icons/remover.png", 210, 30);
        ...
        JButton botaoVoltar = criarBotao("Voltar", "Interface/Icons/voltar.png", 100, 30);
