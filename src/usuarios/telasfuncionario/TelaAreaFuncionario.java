...
public class TelaAreaFuncionario extends JFrame {
    public TelaAreaFuncionario() {
        ...
        JButton botaoVerDados = criarBotao("Visualizar dados", "Interface/Icons/view.png",230, 50);   // espaços extras para centralizar as imagens
        panelGerenciar.add(botaoVerDados);

        JButton botaoAttCadastro = criarBotao("Atualizar dados", "Interface/Icons/update.png",230, 50);   // espaços extras para centralizar as imagens
        panelGerenciar.add(botaoAttCadastro);

        // Botão de mudar a senha
        JButton botaoMudarSenha = criarBotao("Mudar a senha", "Interface/Icons/edit.png",230, 50);
        ...
        JButton botaoAddSessao = criarBotao("Cadastrar nova sessão", "Interface/Icons/adicionar.png",230, 50);   // espaços extras para centralizar as imagens
        ...
        JButton botaoAddFilme = criarBotao("Cadastrar novo filme", "Interface/Icons/adicionar.png",230, 50);   // espaços extras para centralizar as imagens
        panelFilme.add(botaoAddFilme);

        // Botão de remover filme
        JButton botaoRmvFilme = criarBotao("Gerenciar filmes em cartaz", "Interface/Icons/emcartaz.png", 230, 50);
        panelFilme.add(botaoRmvFilme);

        // Botão de editar filme
        JButton botaoEditFilme = criarBotao("Editar um filme", "Interface/Icons/edit.png", 230, 50);
        ...
        JButton botaoAddSala = criarBotao("Visualizar salas", "Interface/Icons/view.png",230, 50);   // espaços extras para centralizar as imagens
        panelSala.add(botaoAddSala);

        // Botão de abrir sala
        JButton botaoAbrirSala = criarBotao("Abrir salas", "Interface/Icons/abrir.png", 230, 50);
        panelSala.add(botaoAbrirSala);

        // Botão de fechar sala
        JButton botaoFecharSala = criarBotao("Fechar salas", "Interface/Icons/fechar.png", 230, 50);
        ...
        JButton botaoGerente = criarBotao("Área do Gerente", "Interface/Icons/gerente.png", 160, 35);
